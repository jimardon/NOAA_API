...
function fixFormFields() {
	...
	//console.log("Setting to " + bdatestring + " " + edatestring);
...
function DateInput(DateName, Required, DateFormat, DefaultDate) {
   ...
   if (arguments.length == 0) document.writeln('<span style="color:red;font-size:' + FontSize + 'px;font-family:' + FontFamily + ';">ERROR: Missing required parameter in call to \'DateInput\': [name of hidden date field].</span>');
      ...
      with (document) {
         ...
         writeln('<select aria-label="month" class="calendarDateInput" style="width: 50px;" id="' + DateName + '_Month_ID" oninput= "updateDataAPI()"onChange="' + DateName + '_Object.changeMonth(this); updateDataAPI();">');
         if (!Required) {
         ...
         writeln('<select' + InitialStatus + ' aria-label="day" class="calendarDateInput" style="width: 50px;" id="' + DateName + '_Day_ID" oninput= "updateDataAPI()"onChange="' + DateName + '_Object.changeDay(this); updateDataAPI();">');
         for (var j=1;j<=eval(DateName + '_Object.picked.dayCount');j++) {
            DaySelected = ((DefaultDate != '') && (eval(DateName + '_Object.picked.day') == j)) ? ' selected' : '';
            writeln('<option' + DaySelected + '>' + j + '</option>');
         }
         writeln('</select>' + String.fromCharCode(13) + '</td>' + String.fromCharCode(13) + '<td valign="middle">');
         writeln('<input' + InitialStatus + ' aria-label="year" class="calendarDateInput" type="text" style="width: 50px;" id="' + DateName + '_Year_ID" size="' + eval(DateName + '_Object.picked.yearPad.length') + '" maxlength="' + eval(DateName + '_Object.picked.yearPad.length') + '" title="Year" value="' + eval(DateName + '_Object.picked.yearPad') + '" onKeyPress="return YearDigitsOnly(event)" onKeyUp="' + DateName + '_Object.checkYear(this); updateDataAPI();" onBlur="' + DateName + '_Object.fixYear(this)">');
         write('<td valign="middle">' + String.fromCharCode(13) + '<a' + InitialStatus + ' id="' + DateName + '_ID_Link" href="javascript:' + DateName + '_Object.show()" onMouseOver="return ' + DateName + '_Object.iconHover(true)" onMouseOut="return ' + DateName + '_Object.iconHover(false); "><img src="' + ImageURL + '" align="baseline" class="calendar-image" title="Calendar" border="0"></a>&nbsp;');
